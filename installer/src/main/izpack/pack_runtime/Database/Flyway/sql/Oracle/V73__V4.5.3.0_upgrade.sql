...
ALTER TABLE ORC_CLUSTER_ENVIRONMENT MODIFY CEN_NODE_NAME NOT NULL;

ALTER TABLE ORC_CLUSTER_ENVIRONMENT ADD CONSTRAINT PK_CLUSTER_ENV PRIMARY KEY (CEN_NODE_NAME);

-- Changeset /opt/liquibase/data/orchestra_4.5.3.0.xml::change-4.5.3.0-02::akn::(Checksum: 6:37f649e3cf49a621046734099b32eab2)
ALTER TABLE ORC_SEQUENCE_COUNTER DROP PRIMARY KEY DROP INDEX;

ALTER TABLE ORC_SEQUENCE_COUNTER MODIFY SCO_CATEGORY VARCHAR2(64);
...
ALTER TABLE ORC_PROCESSINSTANCE_STATE ADD PRS_CLUSTER_LEASE VARCHAR2(255);
...
ALTER TABLE ORC_MESSAGE_LIST MODIFY MLI_ID NOT NULL;
...
ALTER TABLE ORC_MESSAGE_LIST_ENTRY MODIFY MLE_ID NOT NULL;

UPDATE ORC_MESSAGE_LIST_ENTRY SET MLE_REFERENCE = 'dummy' WHERE MLE_REFERENCE IS NULL;

ALTER TABLE ORC_MESSAGE_LIST_ENTRY MODIFY MLE_REFERENCE NOT NULL;
...
ALTER TABLE ORC_MESSAGE_LIST_ENTRY_PROP MODIFY MLP_ID NOT NULL;

UPDATE ORC_MESSAGE_LIST_ENTRY_PROP SET MLP_KEY = 'dummy' WHERE MLP_KEY IS NULL;

ALTER TABLE ORC_MESSAGE_LIST_ENTRY_PROP MODIFY MLP_KEY NOT NULL;

UPDATE ORC_MESSAGE_LIST_ENTRY_PROP SET MLP_REFERENCE = 'dummy' WHERE MLP_REFERENCE IS NULL;

ALTER TABLE ORC_MESSAGE_LIST_ENTRY_PROP MODIFY MLP_REFERENCE NOT NULL;
