...
CREATE TABLE ORC_LTA_MESSAGE_LIST (MLI_IDENTIFIER VARCHAR(256) NOT NULL, MLI_ARCHIVE_TIME datetime NULL, MES_ARCHIVE_INFO VARCHAR(255) NULL);

--  Changeset data/orchestra_4.4.0.3.xml::change-4.4.0.3-03::wli::(Checksum: 6:eff89bca51084f899db725e4f0670c6d)
ALTER TABLE ORC_LTA_MESSAGE_LIST ADD PRIMARY KEY (MLI_IDENTIFIER);
