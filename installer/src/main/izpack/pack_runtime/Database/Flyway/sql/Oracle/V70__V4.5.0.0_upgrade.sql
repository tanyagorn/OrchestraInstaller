...
CREATE TABLE ORC_LOOKUPTABLE (LUT_SCENARIO VARCHAR2(250), LUT_NAME VARCHAR2(250), LUT_DATA BLOB, LUT_DEPLOYED_AT TIMESTAMP, LUT_UNIQUE_NAME VARCHAR2(250) NOT NULL);

CREATE TABLE ORC_SCENARIO_DOC (SDO_SCENARIO VARCHAR2(250), SDO_NAME VARCHAR2(250), SDO_DATA BLOB, SDO_DEPLOYED_AT TIMESTAMP);
...
CREATE TABLE ORC_BUSINESS_CALENDAR (BCAL_ID VARCHAR2(255) NOT NULL, BCAL_NAME VARCHAR2(255), BCAL_DESC VARCHAR2(255), CONSTRAINT PK_BCAL_ID PRIMARY KEY (BCAL_ID));

CREATE TABLE ORC_BUSINESS_CALENDAR_ENTRY (BCE_ID VARCHAR2(255) NOT NULL, BCE_TYPE VARCHAR2(100) NOT NULL, BCE_NAME VARCHAR2(255), BCE_DESCRIPTION VARCHAR2(255), BCE_FIXEDDAY TIMESTAMP, BCE_START_DAY TIMESTAMP, BCE_END_DAY TIMESTAMP, BCE_OFFSET INTEGER, BCE_TIMESPAN_TYPE VARCHAR2(32), BCE_TIMESPAN_VALUE INTEGER, BCAL VARCHAR2(255) NOT NULL, CONSTRAINT PK_BCE_ID PRIMARY KEY (BCE_ID), CONSTRAINT FK_CALENDAR_PARENT FOREIGN KEY (BCAL) REFERENCES ORC_BUSINESS_CALENDAR (BCAL_ID));
...
CREATE TABLE ORC_PROCESS_FIFO_SCHED_CACHE (PFC_ID VARCHAR2(50) NOT NULL, PFC_SCENARIO VARCHAR2(256) NOT NULL, PFC_MODELL_REFERENCE VARCHAR2(256) NOT NULL, PFC_PROCESS_REFERENCE VARCHAR2(256) NOT NULL, PFC_VARIABLES BLOB, PFC_TARGET_NODE VARCHAR2(256), CONSTRAINT PK_PROCESS_FIFO_CACHE PRIMARY KEY (PFC_ID));
