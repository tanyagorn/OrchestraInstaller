...
ALTER TABLE ORC_MESSAGE_REFERERS_UNLOCK DROP PRIMARY KEY DROP INDEX;
...
ALTER TABLE ORC_PROCESS_OVERVIEW DROP PRIMARY KEY DROP INDEX;

UPDATE ORC_PROCESS_OVERVIEW SET POV_NODE = '''ORC''' WHERE POV_NODE IS NULL;

ALTER TABLE ORC_PROCESS_OVERVIEW MODIFY POV_NODE NOT NULL;

ALTER TABLE ORC_PROCESS_OVERVIEW ADD CONSTRAINT PK_ORC_PROCESS_OVERVIEW PRIMARY KEY (POV_SCENARIO, POV_NODE);
