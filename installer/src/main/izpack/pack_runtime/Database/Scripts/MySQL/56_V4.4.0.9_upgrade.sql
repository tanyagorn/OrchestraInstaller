...
ALTER TABLE ORC_LTA_PROCESS_STATE ADD PRIMARY KEY (PRS_PROCESS_ID);

ALTER TABLE ORC_LTA_PROCESS_EXT_BSNS_KEYS ADD PRIMARY KEY (PEK_PROCESS_ID, PEK_BUSINESS_KEY_NAME);
