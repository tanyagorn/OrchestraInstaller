...
(
  ORC_PROCESS_MODEL           VARCHAR2(255 BYTE) NOT NULL,
  ORC_SCENARIO_ID             VARCHAR2(255 BYTE),
  ORC_TOTAL_PROCESS_COUNT     NUMBER,
  ORC_TOTAL_PROCESS_DURATION  NUMBER,
  ORC_FIRST_RUN               TIMESTAMP(6),
  ORC_LAST_RUN                TIMESTAMP(6),
  ORC_MIN_DURATION  NUMBER,
  ORC_MAX_DURATION  NUMBER
);
