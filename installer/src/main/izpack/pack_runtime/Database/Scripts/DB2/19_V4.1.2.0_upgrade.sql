...
ALTER TABLE ORC_EVT_LOCAL_VARIABLES ALTER COLUMN EVV_VALUE SET DATA TYPE VARCHAR ( 512 ) ;
ALTER TABLE ORC_EVT_PROCESS_VARIABLES ALTER COLUMN EVV_VALUE SET DATA TYPE VARCHAR ( 512 ) ;
