...
ALTER TABLE ORC_PROCESS_FIFO_SCHED_CACHE ADD PRIMARY KEY (PFC_PROCESS_REFERENCE);
...
ALTER TABLE ORC_SCENARIO_DOC MODIFY SDO_SCENARIO VARCHAR(250) NOT NULL;

UPDATE ORC_SCENARIO_DOC SET SDO_NAME = 'ORC' WHERE SDO_NAME IS NULL;

ALTER TABLE ORC_SCENARIO_DOC MODIFY SDO_NAME VARCHAR(250) NOT NULL;

ALTER TABLE ORC_SCENARIO_DOC ADD PRIMARY KEY (SDO_SCENARIO, SDO_NAME);

--  Changeset /opt/liquibase/data/orchestra_4.5.2.0.xml::change-4.5.2.0-09::akn::(Checksum: 6:8da24220f9084030be61c658efb6f015)
DROP INDEX IDX_ORC_EVT_LOCAL_VAR_VALUE ON ORC_EVT_LOCAL_VARIABLES;
...
ALTER TABLE ORC_EVT_PROCESS_VARIABLES MODIFY EVV_VALUE VARCHAR(1024);

ALTER TABLE ORC_EVT_LOCAL_VARIABLES MODIFY EVV_VALUE VARCHAR(1024);
