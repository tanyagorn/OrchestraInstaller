...
ALTER TABLE ORC_WORK_QUEUE MODIFY ID VARCHAR(40);
...
--  Changeset /opt/liquibase/data/orchestra_4.5.4.0.xml::change-4.5.4.0-02::akn::(Checksum: 6:94a7a02d40f7a618c3ea9f940c4af550)
DROP INDEX IDX_TOPIC_QUEUE_STATE_TYPE_ID ON ORC_TOPIC_QUEUE;

DROP INDEX IDX_TOPIC_QUEUE_STATE_TYPE_PRIO ON ORC_TOPIC_QUEUE;

ALTER TABLE ORC_TOPIC_QUEUE DROP PRIMARY KEY;

ALTER TABLE ORC_TOPIC_QUEUE MODIFY ID VARCHAR(40);
...
ALTER TABLE ORC_SERVER_SETTINGS ADD MASS_OPERATION_BLOCK_SIZE INT DEFAULT '500';
