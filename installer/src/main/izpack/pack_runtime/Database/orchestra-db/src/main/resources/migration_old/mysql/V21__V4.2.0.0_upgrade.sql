...
insert into ORC_EVENT_ACTIONS(EAC_SOURCE, EAC_ACTION, EAC_DESCRIPTION) values (7, 0, 'Add workitem');
insert into ORC_EVENT_ACTIONS(EAC_SOURCE, EAC_ACTION, EAC_DESCRIPTION) values (7, 1, 'Process workitem');
insert into ORC_EVENT_ACTIONS(EAC_SOURCE, EAC_ACTION, EAC_DESCRIPTION) values (7, 2, 'Dispatch workitem');
insert into ORC_EVENT_ACTIONS(EAC_SOURCE, EAC_ACTION, EAC_DESCRIPTION) values (7, 3, 'Initialize workqueue');

insert into ORC_CLUSTER_LOCK(ORC_LOCK_NAME, ORC_LOCK_STATE, ORC_LOCK_OWNER, ORC_LOCK_SCENARIO) Values ('TIMER', NULL, NULL, 'GLOBAL');

insert into ORC_EVENT_ACTIONS(EAC_SOURCE, EAC_ACTION, EAC_DESCRIPTION) values (2, 13, 'onInfo');
insert into ORC_EVENT_ACTIONS(EAC_SOURCE, EAC_ACTION, EAC_DESCRIPTION) values (2, 14, 'onBusinessKeyAssigned');
