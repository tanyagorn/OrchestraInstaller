...
(
  PRS_SCENARIO     VARCHAR2(250 BYTE),
  PRS_NAME         VARCHAR2(250 BYTE),
  PRS_DATA         BLOB,
  PRS_DEPLOYED_AT  DATE,
  PRS_UNIQUE_NAME  VARCHAR2(250 BYTE) NOT NULL
);
