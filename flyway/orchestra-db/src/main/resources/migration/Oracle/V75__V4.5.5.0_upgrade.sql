...
ALTER TABLE ORC_WORK_QUEUE MODIFY ID VARCHAR2(50);
...
ALTER TABLE ORC_TOPIC_QUEUE MODIFY ID VARCHAR2(50);
...
-- Changeset /opt/liquibase/data/orchestra_4.5.5.0.xml::change-4.5.5.0-09::akn::(Checksum: 6:025cf4d0081c7faf89f05aaaaff2fded)
ALTER TABLE ORC_PROCESS_FIFO_SCHEDULE MODIFY PFS_ID VARCHAR2(100);

-- Changeset /opt/liquibase/data/orchestra_4.5.5.0.xml::change-4.5.5.0-10::akn::(Checksum: 6:f1299940e6b99cfb6efa9c87055e9be1)
CREATE TABLE ORC_WORK_QUEUE_DEL_TOPIC (DTO_TOPIC VARCHAR2(256) NOT NULL, DTO_DELETETOKEN INTEGER NOT NULL, DTO_GLOBAL INTEGER NOT NULL, DTO_NODEID VARCHAR2(32) NOT NULL, DTO_IDENT INTEGER NOT NULL, DTO_QUEUE_TYPE VARCHAR2(1) NOT NULL, CONSTRAINT PK_ORC_WQ_DELTOPIC PRIMARY KEY (DTO_IDENT));
...
CREATE TABLE ORC_TOPIC_QUEUE_DEL_TOPIC (DTO_TOPIC VARCHAR2(256) NOT NULL, DTO_DELETETOKEN INTEGER NOT NULL, DTO_GLOBAL INTEGER NOT NULL, DTO_NODEID VARCHAR2(32) NOT NULL, DTO_IDENT INTEGER NOT NULL, DTO_QUEUE_TYPE VARCHAR2(1) NOT NULL, CONSTRAINT PK_ORC_TQ_DELTOPIC PRIMARY KEY (DTO_IDENT));
...
CREATE TABLE ORC_REST_SVC_PROVIDER (RSP_SCENARIO VARCHAR2(250), RSP_NAME VARCHAR2(250), RSP_DATA BLOB, RSP_DEPLOYED_AT TIMESTAMP, RSP_UNIQUE_NAME VARCHAR2(250) NOT NULL, CONSTRAINT PK_ORC_RSV_PROV PRIMARY KEY (RSP_UNIQUE_NAME));
...
ALTER TABLE ORC_ADAPTER_STATE DROP PRIMARY KEY DROP INDEX;
...
ALTER TABLE ORC_ADAPTER_STATE MODIFY ADS_ADAPTER_ID NOT NULL;
