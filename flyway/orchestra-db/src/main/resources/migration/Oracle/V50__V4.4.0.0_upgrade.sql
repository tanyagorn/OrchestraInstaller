...
ALTER TABLE ORC_PROCESS_SCENARIO ADD PSC_VERSION VARCHAR2(255);
ALTER TABLE ORC_PROCESS_SCENARIO ADD PSC_SCENARIO_IMAGE BLOB;
ALTER TABLE ORC_PROCESS_STATE ADD PRS_VERSION_TAG VARCHAR2(255);
...
CREATE TABLE ORC_PROCESS_SCENARIO_HISTORY (PSC_UNIQUE_NAME VARCHAR2(255) NOT NULL, PSC_NAME VARCHAR2(255) NOT NULL, PSC_VERSION VARCHAR2(255) NOT NULL, PSC_DESCRIPTION VARCHAR2(500), PSC_DEPLOYED_AT TIMESTAMP, PSC_USER VARCHAR2(255), PSC_SCENARIO_IMAGE BLOB);
ALTER TABLE ORC_PROCESS_SCENARIO_HISTORY ADD CONSTRAINT PK_ORC_PROCESS_SCENARIO_HIST PRIMARY KEY (PSC_UNIQUE_NAME, PSC_VERSION);
CREATE TABLE ORC_PROCESS_MODELLS_HIST (PMO_UNIQUE_NAME VARCHAR2(255) NOT NULL, PMO_SCENARIO VARCHAR2(255) NOT NULL, PMO_VERSION VARCHAR2(255) NOT NULL, PMO_NAME VARCHAR2(255), PMO_DATA BLOB, PMO_DEPLOYED_AT TIMESTAMP NOT NULL);
ALTER TABLE ORC_PROCESS_MODELLS_HIST ADD CONSTRAINT PK_ORC_PROCESS_MODELLS_HIST PRIMARY KEY (PMO_UNIQUE_NAME, PMO_VERSION);

-- Changeset ./data/orchestra_master_4.4.0.0.xml::1339688508424-54::akn (generated)::(Checksum: 3:5f3cb517516f017720ceda6c56cd890b)
CREATE TABLE ORC_PROCESS_BUS_EVENT (PBE_PROCESSID VARCHAR2(255) NOT NULL, PBE_EXTERNAL_ELEMENT VARCHAR2(255) NOT NULL, PBE_ELEMENT_TYPE VARCHAR2(255) NOT NULL, PBE_GROUP VARCHAR2(255) NOT NULL, PBE_THROWING NUMBER(1) NOT NULL);
...
ALTER TABLE ORC_MONITOR_SETTINGS ADD ORC_LANGUAGE VARCHAR2(6) DEFAULT 'EN' NOT NULL;
ALTER TABLE ORC_SERVER_SETTINGS ADD LANGUAGE VARCHAR2(6) DEFAULT 'EN' NOT NULL;

-- Changeset ./data/orchestra_master_4.4.0.0.xml::1339688508424-58::akn (generated)::(Checksum: 3:9c0c408d474b721b7b620271a333b17a)
CREATE TABLE ORC_MONITOR_NODES (OMN_NAME VARCHAR2(255) NOT NULL, OMN_HOST VARCHAR2(255), OMN_GROUPNAME VARCHAR2(255), OMN_SSL NUMBER(1), OMN_PORT VARCHAR2(255), OMN_USER_ID VARCHAR2(255), OMN_PASSWORD VARCHAR2(255), OMN_LOCAL NUMBER(1), CONSTRAINT PK_MONITOR_NODES PRIMARY KEY (OMN_NAME));
...
CREATE TABLE ORC_KPI_INSTANCE (KIN_IDENTIFIER VARCHAR2(50) NOT NULL, KIN_CLASS_IDENT VARCHAR2(50) NOT NULL, KIN_OWNER_NODE VARCHAR2(50) NOT NULL, KIN_ABS_OCCURANCE NUMBER(38,0), KIN_ABS_LONGVALUE NUMBER(38,0), KIN_ABS_DOUBLE_VALUE FLOAT, KIN_LASTACCESS TIMESTAMP);
CREATE TABLE ORC_KPI_DIM_VALUE (KDV_INSTANCEID VARCHAR2(50) NOT NULL, KDV_NAME VARCHAR2(50) NOT NULL, KDV_VALUE VARCHAR2(75));
CREATE TABLE ORC_KPI_VALUE (KVA_INSTANCEID VARCHAR2(50) NOT NULL, KVA_TIMEINDEX NUMBER(38,0) NOT NULL, KVA_OCCURANCE NUMBER(38,0), KVA_LONGVALUE NUMBER(38,0), KVA_DOUBLE_VALUE FLOAT);

-- Changeset ./data/orchestra_master_4.4.0.0.xml::1339688508424-60::akn (generated)::(Checksum: 3:b81296993fca3b1a324c347326a20b48)
CREATE TABLE ORC_LTA_MESSAGE (MES_MESSAGE_ID VARCHAR2(255) NOT NULL, MES_MESSAGE_TYPE VARCHAR2(255), MES_CREATED_AT TIMESTAMP, MES_TYPE VARCHAR2(255), MES_REF_COUNT INTEGER, MES_LEASE_TIME TIMESTAMP, MES_ARCHIVE_INFO VARCHAR2(255));
...
CREATE TABLE ORC_LTA_PROCESS_BUS_EVENT (LPB_PROCESSID VARCHAR2(255) NOT NULL, LPB_POS INTEGER NOT NULL, LPB_EXTERNAL_ELEMENT VARCHAR2(255) NOT NULL, LPB_ELEMENT_TYPE VARCHAR2(255) NOT NULL, LPB_GROUP VARCHAR2(255), LPB_THROWING NUMBER(1) NOT NULL, LPB_ARCHIVE_DATE TIMESTAMP);
CREATE TABLE ORC_LTA_PROCESS_EXT_BSNS_KEYS (PEK_PROCESS_ID VARCHAR2(255) NOT NULL, PEK_BUSINESS_KEY_NAME VARCHAR2(255) NOT NULL, PEK_BUSINESS_KEY VARCHAR2(255), PEK_ARCHIVE_DATE TIMESTAMP);
CREATE INDEX IDX_LTA_EXT_BK ON ORC_LTA_PROCESS_EXT_BSNS_KEYS(PEK_BUSINESS_KEY_NAME, PEK_BUSINESS_KEY);
CREATE TABLE ORC_LTA_PROCESS_OVERVIEW (LPO_SCENARIO_ID VARCHAR2(256), LPO_PROCESSED INTEGER, LPO_ABORTED INTEGER);
CREATE TABLE ORC_LTA_PROCESS_STATE (PRS_PROCESS_ID VARCHAR2(255) NOT NULL, PRS_MODELL_ID VARCHAR2(255), PRS_START_TIME TIMESTAMP, PRS_END_TIME TIMESTAMP, PRS_STATE INTEGER, PRS_BUSINESS_KEY VARCHAR2(1024), PRS_SCENARIO_ID VARCHAR2(256), PRS_ROOT_TOKEN VARCHAR2(256), PRS_PROCESS_MODEL VARCHAR2(255), PRS_VERSION_TAG VARCHAR2(255), PRS_CREATE_TIME TIMESTAMP, PRS_BUSEVENT_TYPE INTEGER, PRS_BUSEVENT_REFERENCE VARCHAR2(255), PRS_BUSEVENT_ALIAS VARCHAR2(255), PRS_ARCHIVE_DATE TIMESTAMP, PRS_ARCHIVE_INFO VARCHAR2(255));
...
CREATE TABLE ORC_ESB_ROUTER (ERO_ID VARCHAR2(50) NOT NULL, ERO_TARGET_CELL VARCHAR2(50), ERO_HOP_NAME VARCHAR2(50), ERO_ORCHESTRA_NODE VARCHAR2(50), CONSTRAINT PK_ESB_ROUTER PRIMARY KEY (ERO_ID));
CREATE INDEX IDX_ESB_ROUTER_NODE_TARGET ON ORC_ESB_ROUTER(ERO_ORCHESTRA_NODE, ERO_TARGET_CELL);
CREATE TABLE ORC_ESB_TCP_CELL (ETC_CELL_ID VARCHAR2(50) NOT NULL, ETC_ORCHESTRA_NODE VARCHAR2(50) NOT NULL, ETC_CELLNAME VARCHAR2(50) NOT NULL, ETC_ENDPOINT VARCHAR2(50), ETC_PASSWORD VARCHAR2(50), ETC_PORT INTEGER, ETC_INGOING NUMBER(1) NOT NULL, CONSTRAINT PK_ESB_TCP_CELL PRIMARY KEY (ETC_CELL_ID));
...
ALTER TABLE ORC_USER_PWD_TABLE ADD OUP_USERNAME VARCHAR2(255);
