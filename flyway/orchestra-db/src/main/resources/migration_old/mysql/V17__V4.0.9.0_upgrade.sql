...
insert into ORC_EVENT_SOURCE (ESO_SOURCE, ESO_DESCRIPTION) values (10, 'EventEngine');
insert into ORC_EVENT_SOURCE (ESO_SOURCE, ESO_DESCRIPTION) values (11, 'ServiceBus');
insert into ORC_EVENT_SOURCE (ESO_SOURCE, ESO_DESCRIPTION) values (12, 'ScriptingEngine');
insert into ORC_EVENT_SOURCE (ESO_SOURCE, ESO_DESCRIPTION) values (13, 'PartnerSystem');

insert into ORC_EVENT_ACTIONS (EAC_SOURCE, EAC_ACTION, EAC_DESCRIPTION) values (13, 0, 'sendToPartner');
insert into ORC_EVENT_ACTIONS (EAC_SOURCE, EAC_ACTION, EAC_DESCRIPTION) values (13, 1, 'ResultFromPartner');
insert into ORC_EVENT_ACTIONS (EAC_SOURCE, EAC_ACTION, EAC_DESCRIPTION) values (13, 2, 'publishComplete');

insert into ORC_EVENT_SOURCE (ESO_SOURCE, ESO_DESCRIPTION) values (14, 'CellCommunication');
insert into ORC_EVENT_ACTIONS(EAC_SOURCE, EAC_ACTION, EAC_DESCRIPTION) values (14, 0, 'Connect master to peer');
insert into ORC_EVENT_ACTIONS(EAC_SOURCE, EAC_ACTION, EAC_DESCRIPTION) values (14, 1, 'General cell error');
insert into ORC_EVENT_ACTIONS(EAC_SOURCE, EAC_ACTION, EAC_DESCRIPTION) values (14, 2, 'Connect request');
insert into ORC_EVENT_ACTIONS(EAC_SOURCE, EAC_ACTION, EAC_DESCRIPTION) values (14, 3, 'Cell processing');
insert into ORC_EVENT_ACTIONS(EAC_SOURCE, EAC_ACTION, EAC_DESCRIPTION) values (14, 4, 'Successfull connect');
...
ALTER TABLE JBPM_BYTEBLOCK MODIFY  PROCESSFILE_ bigint Not null;

ALTER TABLE JBPM_BYTEBLOCK MODIFY  BYTES_ longblob;
...
ALTER TABLE ORC_JBPM_PROCESS_DEFINITION MODIFY  PMO_DATA longblob;
