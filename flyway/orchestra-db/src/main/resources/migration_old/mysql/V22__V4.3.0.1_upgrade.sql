...
ALTER TABLE ORC_EVENT_SOURCE ADD CONSTRAINT PK_ORC_EVENT_SOURCE PRIMARY KEY (ESO_SOURCE);

ALTER TABLE ORC_EVENT_ACTIONS ADD CONSTRAINT PK_ORC_EVENT_ACTIONS PRIMARY KEY (EAC_SOURCE, EAC_ACTION);
...
UPDATE ORC_EVENT_SOURCE SET ESO_DESCRIPTION = 'Security' WHERE ESO_SOURCE = 6;
